				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html">
							<img src="<?php echo $this->config->item('images'); ?>logo.png" alt="Clip-Two"/>
						</a>
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
											...
											<ul>
												...
												<li>
													<a href="javascript:;" class="unread">
														<div class="clearfix">
															<div class="thread-image">
																<img src="<?php echo $this->config->item('vendor')?>images/avatar-3.jpg" alt="">
															</div>
															<div class="thread-content">
												...
												<li>
													<a href="javascript:;">
														<div class="clearfix">
															<div class="thread-image">
																<img src="<?php echo $this->config->item('vendor')?>images/avatar-5.jpg" alt="">
															</div>
															<div class="thread-content">
										...
										<div class="drop-down-wrapper ps-container">
											<div class="list-group no-margin">
												<a class="media list-group-item" href="">
													<img class="img-circle" alt="..." src="<?php echo $this->config->item('vendor')?>images/avatar-1.jpg">
							...
							<li class="dropdown current-user">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<img src="<?php echo $this->config->item('vendor')?>images/avatar-1.jpg" alt="Peter"> <span class="username">Peter <i class="ti-angle-down"></i></i></span>
								</a>

'use strict';
var baseUrl = "/webox-1.0";
var Main = function() {
	var $html = $('html'), $win = $(window), wrap = $('.app-aside'), MEDIAQUERY = {}, app = $('#app');
//    if ($('body').html().indexOf('NULL') > 0) {
//        $('body').html().replace('NULL', '');
//        var str = $('body').html();
//        console.log($('body').html());
//
//        var postion = $('body').html().indexOf('NULL');//its 0 based
//        $('body').html().substring(0, postion - 1) + $('body').html().substring(postion, $('body').html().length);
//
//
//    }
	MEDIAQUERY = {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", baseUrl+"/vendor/style/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", baseUrl+"/vendor/style/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", baseUrl+"/vendor/images/logo2.png");
					break;
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", baseUrl+"/vendor/style/themes/theme-5.css");
			$(".navbar-brand img").attr("src", baseUrl+"/vendor/images/logo2.png");
